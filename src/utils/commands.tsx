      ...
      return (
        <div className="space-y-4 mt-4">
          {[
            ...
            {
              name: "🌐 AI Web Developer (Work in Progress)",
              desc: "Tech Stack: Gemini API, Web Scraping, Multi-Agent System. Mimics real developer workflows with a Main Agent handling prompt parsing and sub-agents managing UI search, backend generation, and fullstack integration to build complete apps from prompts.",
              link: undefined,
              github: undefined,
              npm: undefined,
              crate: undefined,
